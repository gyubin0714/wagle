        ...
        <div id="content">
            <div id="content2">
                ...
                <div class="content2_2">
                    <h4><b>FAQ 자주묻는질문 수정</b></h4>
                </div>
                <form action="<%= contextPath %>/faqUpdate.no" id="update-form" method="post">
                    <input type="hidden" name="fno" value="<%= n.getFaqNo() %>">

                    <table align="center" id="n_update-area">
                        <tr>
                            <th width="150" height="70px">문의유형</th>
                            <td width="600">
                    ...
                    <div align="center">
                        <button type="submit" class="n_enroll_btn" onclick="return updateFaq();">수정하기</button>
