<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="java.util.ArrayList, com.kh.auction.model.vo.Auction" %>
<%
    ArrayList<Auction> searchList = (ArrayList)request.getAttribute("searchList");
                    ...
                    <table>
                        <tr>
                            <td>
                                ...
                                <option value="memId">작성자ID</option>
                                </select>
                            </td>
                            <td>
